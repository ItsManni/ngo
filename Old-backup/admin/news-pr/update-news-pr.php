...
<head>
    ...
    <!-- TITLE -->
    <title>Update News & PR - <?= $_ProductName ?></title>
    <?php
    ...
    $case_details_data = $NewsPR->GetNewsPRDetailsbyID($NewsID);
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header mb-3">
                            <h1 class="page-title">Update News & PR </h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="../dashboard/admin-dashboard">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update News & PR </li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                                            ...
                                            <div class="row align-items-center">
                                                <div class="mb-3 col-12 col-md-8">
                                                    ...
                                                    <input type="file" class="form-control" name="NewsBanner"
                                                        id="NewsBanner" accept="image/png, image/jpg, image/jpeg, image/webp">
                                                    <input type="hidden" name="old_cs_img" id="old_cs_img"
                                                        value='<?php echo $case_details_data['NewsBanner'];?>'>
                                                </div>
                                                <div class="mb-0 col-12 col-md-4">
                                                    <img src="../project-assets/admin-media/newspr/<?php echo $case_details_data['NewsBanner']; ?>"
                                                        alt="" width='100px'>
                                                </div>
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    <label for="recipient-name" class="col-form-label">News Date <span
                                                            class="text-danger">*<span></label>
                                                    <input type="text" class="form-control fc-datepicker" name="NewsDate"
                                                        id="NewsDate" Placeholder="Enter News Date"
                                                        value='<?php echo $case_details_data['NewsDate'];?>'>
                                                </div>
                                                ...
                                                <div class="mb-3 col-12 col-md-12   ">
                                                    ...
                                                    <textarea cols="30" rows="4" type="text" class="form-control"
                                                        ...
                                                        Placeholder="Enter News Description"><?php echo $case_details_data['NewsDescription'];?></textarea>
                                                </div>
                                                ...
                                                <div class="mb-3 col-12 col-md-12">
                                                    ...
                                                    <textarea cols="30" rows="10" type="text"
                                                        ...
                                                        id="NewsContent"
                                                        Placeholder="Enter News Content"><?php echo $case_details_data['NewsContent'];?></textarea>
                                                </div>
