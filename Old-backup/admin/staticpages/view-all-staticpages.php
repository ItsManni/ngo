...
<body class="app sidebar-mini ltr light-mode">
    <div class="page">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row pb-5 justify-content-end">
                            <div class="col-md-4 text-end">
                                <span onclick="AddStaticPage()" class="btn btn-success">Add Static Page</span>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h3 class="modal-title" id="StaticPageHeading"></h3>
                            ...
                            <form id="static_page_form" onsubmit="return false;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-12 col-md-12">
                                        <label for="recipient-name" class="col-form-label">Page Content
                                        </label>
                                        <textarea type="text" class="form-control summernote"
                                            name="PageContent" id="PageContent"
                                ...
                                <div class="mt-5 text-center">
                                    <button class="btn btn-success text-white" id="addStaticPageBtn"
                                        onclick="AddUpdateStaticPageForm()"></button>
                                </div>
       ...
       include("../navigation/right-side-navigation.php");
        ...
        ?>
        <script src="../project-assets/js/static-page.js"></script>
        ...
        $(document).ready(function() {
            $("#nav_static_page").addClass("active");
        });
