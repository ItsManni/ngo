$(function (e) {
    ...
    document.querySelectorAll('.leadschart').forEach(canvas => {
    ...
    document.querySelectorAll('.saleschart').forEach(canvas => {
        const ctx = canvas.getContext('2d');
        new Chart(ctx, {
            type: 'bar',
            data: {
    ...
    // PROFIT CHART OPEN
    document.querySelectorAll('.profitchart').forEach(canvas => {
        const ctx = canvas.getContext('2d');
        new Chart(ctx, {
            type: 'bar',
            data: {
    ...
    // COST CHART OPEN
    document.querySelectorAll('.costchart').forEach(canvas => {
        const ctx = canvas.getContext('2d');
        new Chart(ctx, {
            type: 'line',
            data: {
    ...
    // RECENT ORDERS OPEN
    document.querySelectorAll('.recentorders').forEach(canvas => {
        canvas.height = 225;
        new Chart(canvas, {
            type: 'bar',
            data: {
