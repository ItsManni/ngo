  ...
  <div class="sticky">
      ...
      <div class="app-sidebar">
          ...
          <div class="side-header">
              ...
              <a class="header-brand1" href="../dashboard/admin-dashboard">
                  ...
                  <img src="<?= $_ProductIcon ?>" class="header-brand-img toggle-logo" alt="logo">
              ...
              <ul class="side-menu">
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item has-link" id="dasboard" data-bs-toggle="slide"
                          ...
                          href="../dashboard/admin-dashboard"><i class="side-menu__icon fe fe-home"></i><span
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_freeresource" data-bs-toggle="slide"
                          ...
                          href="javascript:void(0)"><i class="side-menu__icon fe fe-slack"></i><span
                              ...
                              class="side-menu__label">Free Resources</span><i class="angle fe fe-chevron-right"></i>
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../free-resources/view-current-all-pdfs" class="slide-item"



                                                      id="nav_current_affairs">Current Affairs</a></li>



                                              <li><a href="../free-resources/view-monthly-all-pdfs" class="slide-item"



                                                      id="nav_monthly_affairs">Monthly Affairs</a></li>



                                              <li><a href="../free-resources/view-all-magazine" class="slide-item"



                                                      id="nav_magazine">Magazine</a></li>
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_enquiries" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Enquiries
                      ...
                      <ul class="slide-menu" id="nav_enquiries_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../enquiries/view-all-join-enquiries" class="slide-item"



                                                      id="nav_all_join_enquiries">View All JoinUs Enquiries </a>
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_donations" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Donations
                      ...
                      <ul class="slide-menu" id="nav_donations_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../donation/view-all-donations" class="slide-item"



                                                      id="nav_all_donations">View All Donations</a>
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_homepage" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Home Page
                      ...
                      <ul class="slide-menu" id="nav_homepage_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../banner/view-all-banner" class="slide-item"



                                                      id="nav_banner">Banner</a></li>



                                               <li><a href="../home/view-slider-category" class="slide-item"



                                                      id="nav_home_slider">Product Slider</a></li>



                                               <li><a href="../client/view-all-client" class="slide-item"



                                                      id="nav_client">Client Logo</a></li>



                                                 <li><a href="../home/add-update-home-section" class="slide-item"



                                                      id="nav_home_page">Other Section</a></li>
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_aboutus" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">About Page
                      ...
                      <ul class="slide-menu" id="nav_aboutus_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../testimonial/view-all-testimonial" class="slide-item"



                                                      id="nav_testimonial">Testimonial</a></li>
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_websiteedit" data-bs-toggle="slide"
                          ...
                          href="javascript:void(0)"><i class="side-menu__icon fe fe-slack"></i><span
                              ...
                              class="side-menu__label">Common Setting
                      ...
                      <ul class="slide-menu" id="nav_websiteedit_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <!-- <li><a href="../custom-code/add-custom-code" class="slide-item"



                                                      id="nav_custom_code">Custom Code</a></li> -->



                                              <li><a href="../team/view-all-team" class="slide-item"



                                                      id="nav_teams">Volunteer</a></li>



                                              <!-- <li><a href="../seopages/view-all-seo-pages" class="slide-item"



                                                      id="nav_seo_pages">SEO Pages</a></li> -->
                   ...
                   <?php if($navigation->_Nav_Products){ ?>
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_all_product" data-bs-toggle="slide" href="../products/view-all-products">

                          <i class="side-menu__icon fa fa-shopping-bag"></i>

                          <span class="side-menu__label">हमारे सभी प्रोडक्ट्स</span>
                  ...
                  <?php if($navigation->_Nav_Gallery){ ?>
                  <li class="sub-category">
                  ...
                  <li class="slide">
                      <a class="side-menu__item" id="nav_all_gallery" data-bs-toggle="slide" href="../gallery/view-all-gallery-list">
                        <i class="side-menu__icon fa fa-image"></i>
                 ...
                 <?php if($navigation->_Nav_Volunteer){ ?>
                  ...
                  <li class="slide">
                      <a class="side-menu__item" id="nav_all_volunteer" data-bs-toggle="slide" href="../volunteer/view-all-volunteer">
                  ...
                  <?php if($navigation->_Nav_Testimonials){ ?>
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_testimonials" data-bs-toggle="slide" href="../testimonial/view-all-testimonial"><i class="side-menu__icon fa fa-star"></i><span class="side-menu__label">टेस्टिमोनियल्स</span></a>
                  ...
                  <?php } ?>
                    ...
                    <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_custom_code" data-bs-toggle="slide"



                          href="../banner/view-all-banner"><i class="side-menu__icon fa fa-file-image-o"></i><span
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_custom_code" data-bs-toggle="slide"
                          ...
                          href="../custom-code/add-custom-code"><i class="side-menu__icon fa fa-code"></i><span



                              class="side-menu__label">Custom Code</span></a>
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_custom_code" data-bs-toggle="slide"
                          ...
                          href="../events/view-all-events"><i class="side-menu__icon fa fa-calendar-check-o"></i><span
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_custom_code" data-bs-toggle="slide"
                          ...
                          href="../staticpages/view-all-staticpages"><i



                              class="side-menu__icon fa fa-calendar-check-o"></i><span class="side-menu__label">Static
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_teams" data-bs-toggle="slide" href="../team/view-all-team"><i



                              class="side-menu__icon mdi mdi-account-multiple-plus"></i><span
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_case_studies" data-bs-toggle="slide"
                          ...
                          href="javascript:void(0)"><i class="side-menu__icon fe fe-slack"></i><span
                              ...
                              class="side-menu__label">Case Studies
                      ...
                      <ul class="slide-menu" id="nav_case_studies_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../case-studies/add-case-studies" class="slide-item"



                                                      id="nav_add_case_studies">Add Case Studies
                                              ...
                                              <li><a href="../case-studies/view-all-case-studies" class="slide-item"



                                                      id="nav_all_case_studies">View All Case Studies </a></li>
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_news_pr" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">News & PR
                      ...
                      <ul class="slide-menu" id="nav_news_pr_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../news-pr/add-news-pr" class="slide-item"



                                                      id="nav_add_news_pr">Add News & PR
                                              ...
                                              <li><a href="../news-pr/view-all-news-pr" class="slide-item"



                                                      id="nav_all_news_pr">View All News & PR </a></li>
                  ...
                  <!-- <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_blogs" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Blog & Articles
                      ...
                      <ul class="slide-menu" id="nav_blogs_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../blogs/view-all-blog-category" class="slide-item"



                                                      id="nav_blog_category">Add
                                              ...
                                              <li><a href="../blogs/add-blog" class="slide-item" id="nav_add_blogs">Add
                                              ...
                                              <li><a href="../blogs/view-all-blogs" class="slide-item"



                                                      id="nav_all_blogs">View All Blog & Articles </a></li>
...
<!-- 
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_gallery" data-bs-toggle="slide" href="javascript:void(0)"><i



                              class="side-menu__icon fe fe-slack"></i><span class="side-menu__label">Gallery & Video
                      ...
                      <ul class="slide-menu" id="nav_gallery_li">
                                  ...
                                  <div class="tab-content">
                                      ...
                                      <div class="tab-pane active" id="side1">
                                          ...
                                          <ul class="sidemenu-list">
                                              ...
                                              <li><a href="../gallery/view-all-gallery" class="slide-item"



                                                      id="nav_all_gallery">View All Gallery Images</a></li>



                                              <li><a href="../gallery/view-all-gallery-video" class="slide-item"



                                                      id="nav_all_gallery_video">View All Gallery Videos </a></li>
                  ...
                  <li class="slide">
                      ...
                      <a class="side-menu__item" id="nav_user" data-bs-toggle="slide" href="../users/view-users.php"><i
