...
<head>
    ...
    <!-- TITLE -->
    <title>Add Gallery Images - <?= $_ProductName ?></title>
    <?php
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header mb-3">
                            <h1 class="page-title">Add Gallery Images</h1>
                            <div>
                                <ol class="breadcrumb">
                                ...
                                <div class="col-lg-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-12 col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="GalleryTitle"
                                                        id="GalleryTitle" Placeholder="Enter Gallery Title" onkeyup="generateUrl()">
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <input type="hidden" id="new_gallery_counter" value=1 />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header flex-column align-items-start">
                                            <label for="FeatureImage"><b>Gallery Feature Image <span
