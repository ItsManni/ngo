                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row pb-5 justify-content-end">
                            <div class="col-md-4 text-end">
                                <a href="./add-gallery" class="btn btn-success">Add Gallery Images</a>
                            </div>
                        </div>
                                            ...
                                            <table class="table table-bordered text-nowrap border-bottom"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">Feature Image</th>
                                                        <th class="wd-15p border-bottom-0">Gallery Title</th>
