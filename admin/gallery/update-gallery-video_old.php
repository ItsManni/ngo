...
<head>
    ...
    $gallery_details_data = $GalleryVideo->GetGalleryVideoDetailsbyID($GalleryID);
                        ...
                        <div class="page-header mb-3">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="./view-all-gallery-video">All Gallery Video</a></li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="mb-3 col-12 col-md-12">
                                                    <label for="recipient-name" class="col-form-label">Embed Video Link<span
                                                            class="text-danger">*<span></label>
                                                    <input type="text" class="form-control"
                                                        name="VideoTitle" id="VideoTitle" Placeholder="Enter Video Title"
                                                        value="<?php echo $gallery_details_data['Title'];?>">
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-12 col-md-12">
                                                    <label for="recipient-name" class="col-form-label">Video Details</label>
                                                    <textarea class="form-control"
                                                        name="VideoCode" id="VideoCode"
                                                        Placeholder="Enter Video Code Here"><?php echo $gallery_details_data['VideoCode'];?></textarea>
                                                </div>
                                            </div>
